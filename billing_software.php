...
<body>
  ...
  <!-- Hero section start -->
  <div class="container-fluid pos_bg-hero">
    <div class="container">
      <div class="row">
        <div class="col-7">
  ...
  <div class="container-fluid my-2 my-lg-5 ">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h3 class="fw-bolder text-center text-family tool">Tools to help your business succeed</h3>
        </div>
      </div>
    </div>
  </div>
  <!-- Tools to help your business succeed end -->
  ...
  <div class="container-fluid">
    <div class="container">
      <div class="row set-hide-pos" id="rmve5">
        ...
        <div class="col-12 col-lg-5  my-2 my-lg-5 sm-allll">
          <div>
            <img src="./assets/empl.png" class="poin-eff" alt="@dued">
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container-fluid">
    <div class="container">
      <div class="row set-hide-pos" id="rmve7">
        ...
        <div class="col-12 col-lg-5  my-2 my-lg-5 sm-allll ">
          <div>
            <img src="./assets/multi.png" class="poin-eff" alt="@dued">
          </div>
        </div>
      </div>
    </div>
