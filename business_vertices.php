...
<body>
    ...
    <!-- hero section start -->
    <div class="container-fluid set-img-business">
        <div class="container">
            <div class="row">
                <div class="col-8">
                    <div class="busin-ver-txt">
    ...
    <div class="container my-2 my-lg-5 ">
        <div class="row">
            ...
            <div class=" col-12 col-md-7 d-flex justify-content-center align-items-center my-2 ">
                <div class="business-heading   ps-md-3">
                   <div>
                    <h3>Business</h3>
                   </div>
                   <div>
    ...
    <div class="container my-3 my-lg-5  ">
      <div class="row">
        ...
        <div class="col-md-3 col-lg-3 my-2 my-lg-3 ">
            ...
            <h6 class="fw-bolder mt-3 text-center">CA Plus</h6>
        </div>
      </div>
    </div>
