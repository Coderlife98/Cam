                ...
                <div class="col-12 col-md-6 col-lg-4 my-2">
                    <div class="app-box">
                        ...
                        <div class="app-pa-box">
                            <p class="text-justify">Here we work with you to clarify the brief and define your needs so that we can make sure we’re all on the same page and can deliver the right solution.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4 my-2">
                    <div class="app-box">
                        ...
                        <div class="app-pa-box">
                            <p class="text-justify">Having completed the exploration stage, we start working on the UX and UI of your mobile app. We create wire frames which we share with you to demonstrate the flow from one page to the next.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-4 my-2">
                    <div class="app-box">
                        ...
                        <div class="app-pa-box">
                            <p class="text-justify" >We will fully explain how you can make changes in the app, and offer full maintenance and support to ensure that your app grows alongside your business.</p>
                        </div>
                    </div>
                </div>
