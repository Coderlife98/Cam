...
<div class="container my-2 my-lg-5 ">
    <div class="row">
        <div class="col-12 col-lg-8 pe-lg-5 ">
            <h2 class="set-head-in fw-bolder ">Welcome to <span class="txt-color">Camwel Solution</span></h2>
            <div class="para-blog ">
                <p class="text-justify">We are the experienced company in software industry. Here we provide Software Development for Banking, <b>Nidhi Company</b>,<b> Microfinance</b>, <b>NBFC</b>, <b>Chitfund</b>, <b>MLM</b>, <b>Network Marketing</b>, <b>Transportation booking</b>, <b>Block chain and School Management</b>.</p>
            </div>
            <div class="why-blog mt-4 ">
                <h3 class="set-head-in">Why we choose Camwel Solution</h3>
                <p class="text-justify">As in today market people are thinking for trust and reliability in business. When we look in market we find many companies who develop software in fewer prices but as process start we will come to know the loop fall and many other hidden charges, which will affect in new company stability and in financial growth. There is more issue occurred regarding calculation and reporting which effect customer in their business. Therefore we recommend choosing Camwel Solution for person who knows the market well and for person who is new in this field. Here we guide the customer in every step to make things better; we give proper guideline, reports, assurance, support, trust and more important value for money.</p>
                <p class="text-justify">We have worked with make client in growing their business and always found 100% customer satisfaction.</p>
            </div>
        </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-4 my-2 my-2 ">
            <div class="out-blo-box p-2  d-flex align-items-center justify-content-evenly ">
                <div class="img-software-blog">
...
<!-- section 2 start -->
 ...
 <dib class="container">
    <div class="row">
       <div class="col-12 text-center ">
          <h2 class="add-desi-head ">Our Playlists</h2>
       </div>
    </div>
 </dib>
 ...
 <div class="container">
    <div class="row  ">
    <div class="col-12 col-md-6 col-lg-4  hov-eff  ">
          <!-- 2 -->
